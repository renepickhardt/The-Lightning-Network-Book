...
\newglossaryentry{input}{name={Input Script},
  description={The Input Script is a script to prove that you own some bitcoins.}}
\newglossaryentry{output}{name={Output Script},
  description={The Output Script is a script where you designate someone else or multiple other parties to be able to prove they own some bitcoins.}}
...
\end{itemize}
\subsection{Loss of keys or passwords}
\todo{E.g. \url{https://arstechnica.com/information-technology/2019/02/digital-exchange-loses-137-million-as-founder-takes-passwords-to-the-grave/}}
...
\chapter{The near and long-term future of Lightning}
\todo{Explain that we are still in the initial phase of the Lightning Network roll-out. Over the coming years the BOLT protocol will be added to and built upon.}
\section{Upcoming Products and Services}
\subsection{Light Lightning Wallets}
\todo{Using SPV or Neutrino for Bitcoin validation and remote nodes for Lightning.}
\section{Possibilities}
\subsection{Atomic swaps}
\todo{Mention that on November 16, 2017 Lightning Labs used the Lightning Network to make the first cross-chain atomic swap from Bitcoin to Litecoin. \footnote{\url{https://blockexplorer.com/news/lightning-network-makes-first-cross-chain-swap-from-bitcoin-to-litecoin/}}
\subsection{Minimal-trust exchanges}
\todo{Explain exchanges without third parties that use cross-chain atomic swaps.}
